...
class SelphIDResult
{
  ...
  String? faceImage;
  List? encodedDataImages;
  List? tokenEncodedDataImages;
  ...
  SelphIDResult({
    ...
    required this.encodedDataImages,
    required this.tokenEncodedDataImages
  });
  ...
  Map<String, dynamic> toMap() {
    return {
      ...
      'encodedDataImages': encodedDataImages,
      'tokenEncodedDataImages': tokenEncodedDataImages
    };
  }
  ...
  static SelphIDResult fromMap(Map<dynamic, dynamic> map) {
    return SelphIDResult(
      ...
      matchingSidesScore: (map['matchingSidesScore'] as num?)?.toDouble() ?? 0.0,
      encodedDataImages: map['encodedDataImages'] is List ? List.from(map['encodedDataImages']) : null,
      tokenEncodedDataImages: map['tokenEncodedDataImages'] is List ? List.from(map['tokenEncodedDataImages']) : null,
    );
  }
